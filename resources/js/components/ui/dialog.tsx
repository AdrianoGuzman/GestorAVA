 ...
 */
function NonModalOverlay({ open, onClose, className }: { open: boolean; onClose: () => void; className?: string }) {
    if (!open) return null;

    return createPortal(<div className={cn('fixed inset-0 z-40 bg-black/50 backdrop-blur-md', className)} onClick={onClose} />, document.body);
}
