...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * En true: sin esto, cambiar el body a 'DejaVu Sans' (necesario para el
         * glifo de "→" en el detalle del historial, RF-16/24 D2 -- Helvetica no
         * lo trae) embebe la tipografia completa en cada PDF (~880KB para una
         * ficha de una pagina). Con subsetting solo se embeben los glifos que
         * el documento realmente usa.
         */
